...
def load_and_split_dataset(dataset_name,
    ...
    # =========================
    X_temp, X_test, y_reg_temp, y_reg_test, y_class_temp, y_class_test, y_split_temp, y_split_test = train_test_split(
        X, y_reg, y_class, y_split,
        test_size=test_size,
        stratify=y_split,
    ...
    X_train, X_val, y_reg_train, y_reg_val, y_class_train, y_class_val, y_split_train, y_split_val = train_test_split(
        X_temp, y_reg_temp, y_class_temp, y_split_temp,
